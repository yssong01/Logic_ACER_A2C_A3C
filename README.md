...
본 과제는 A2C(Advantage Actor-Critic), A3C(Asynchronous Advantage Actor-Critic), ACER(Actor-Critic with Experience Replay)를 동일한 환경과 조건에서 구현하여 학습 효율, 수렴 속도, 성능 안정성을 실험적으로 검증한다.
